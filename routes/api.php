...
//     Route::post('/signout', [AuthController::class, 'signout'])->middleware('auth:client');
// });
...
Route::prefix('v1/staff')->group(function () {
    ...
    Route::post('/signout', [StaffAuthController::class, 'signout'])->middleware('auth:staff');
    Route::get('/information', [StaffController::class, 'getInformation'])->middleware('auth:staff');
});

// 快递员功能
Route::prefix('v1/courier')->middleware(['auth:staff', 'courier'])->group(function () {
...
// 卡车司机功能
// Route::prefix('v1/trucker')->middleware(['auth:staff', 'trucker'])->group(function () {
